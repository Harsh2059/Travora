...
export const TechnicalDetailsDrawer: React.FC<TechnicalDetailsDrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden bg-slate-950/80 backdrop-blur-sm flex justify-end animate-fade-in">
      <div className="w-full max-w-4xl bg-slate-900 border-l border-slate-800 shadow-2xl h-full flex flex-col">
        {/* Header */}
            ...
            <div className="p-5 rounded-2xl bg-slate-950 border border-slate-800">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                <div className="p-3 rounded-xl bg-slate-900 border border-slate-800">
                  ...
                  <span className="font-bold text-slate-200">{activePlan.time_score?.toFixed(1) ?? '90.0'}%</span>
                </div>
                <div className="p-3 rounded-xl bg-slate-900 border border-slate-800">
                  <span className="text-slate-500 block mb-1">Cost Score</span>
                  <span className="font-bold text-slate-200">{activePlan.cost_score?.toFixed(1) ?? '85.0'}%</span>
                </div>
                <div className="p-3 rounded-xl bg-slate-900 border border-slate-800">
                  <span className="text-slate-500 block mb-1">Comfort Score</span>
                  <span className="font-bold text-slate-200">{activePlan.comfort_score?.toFixed(1) ?? '95.0'}%</span>
                </div>
                <div className="p-3 rounded-xl bg-slate-900 border border-slate-800">
                  <span className="text-slate-500 block mb-1">Directness Score</span>
                  <span className="font-bold text-slate-200">{activePlan.directness_score?.toFixed(1) ?? '100.0'}%</span>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div>
                <div className="flex justify-between text-slate-300 mb-1">
                  ...
                  <span className="font-bold text-blue-400">{preferences.time_weight.toFixed(2)}</span>
                </div>
                <input
                  type="range"
                  min="0"
              ...
              <div>
                <div className="flex justify-between text-slate-300 mb-1">
                  ...
                  <span className="font-bold text-blue-400">{preferences.cost_weight.toFixed(2)}</span>
                </div>
                <input
                  type="range"
                  min="0"
              ...
              <div>
                <div className="flex justify-between text-slate-300 mb-1">
                  ...
                  <span className="font-bold text-blue-400">{preferences.comfort_weight.toFixed(2)}</span>
                </div>
                <input
                  type="range"
                  min="0"
              ...
              <div>
                <div className="flex justify-between text-slate-300 mb-1">
                  ...
                  <span className="font-bold text-blue-400">{preferences.directness_weight.toFixed(2)}</span>
                </div>
                <input
                  type="range"
                  min="0"
